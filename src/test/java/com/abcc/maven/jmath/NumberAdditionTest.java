...
public class NumberAdditionTest {
	...
	public void A2N_TestCase1() {
		...
		int iResult = TestNA.add2numbers(15, 25);
	...
	public void A2N_TestCase2() {
		...
		TestNA = new NumberAdditions();
		int iResult = TestNA.add2numbers(30, 25);
	...
	public void A2N_TestCase3() {
		...
		TestNA = new NumberAdditions();
		int iResult = TestNA.add2numbers(75, 25);
	...
	public void A3N_TestCase1() {
		...
		TestNA = new NumberAdditions();
		int iResult = TestNA.add3numbers(15, 25, 30);
	...
	public void A3N_TestCase3() {
		...
		TestNA = new NumberAdditions();
		int iResult = TestNA.add3numbers(80, 20, 30);
	...
	public void A3N_TestCase4() {
		...
		TestNA = new NumberAdditions();
		int iResult = TestNA.add3numbers(10, 20, 30);
